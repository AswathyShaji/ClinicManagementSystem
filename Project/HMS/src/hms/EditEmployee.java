...
public class EditEmployee extends javax.swing.JFrame {
 ...
 public void fillstate()
      ...
      public void fillemp()
    {
        ...
        {
            MysqlConnection db = new MysqlConnection();
            pst=db.connection.prepareStatement("SELECT * from hms_employeeregistration" );
            rs=pst.executeQuery();
            while(rs.next())
            {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("ACTYMED | EDIT EMPLOYEE");
    ...
    private void comboopItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboopItemStateChanged
        try
        {
            ...
            lblop.setText(op);
            pst=db.connection.prepareStatement("select * from hms_employeeregistration o\n" +
                "inner join hms_place p on p.place_id=o.place_id\n" +
                "inner join hms_district d on p.district_id=d.district_id\n" +
                "inner join hms_state s on s.state_id=d.state_id where o.emp_id=?" );
            pst.setString(1, op);
            rs=pst.executeQuery();
            while(rs.next())
            {
                txtname.setText(rs.getString("emp_name"));
                txtage.setText(rs.getString("emp_age"));
                txtaddress.setText(rs.getString("emp_address"));
                txtphone.setText(rs.getString("emp_phone"));
                txtemail.setText(rs.getString("emp_email"));
...
public void deletedata() {
       try
       {
        ...
        String op=comboop.getSelectedItem().toString();
        lblop.setText(op);
        String del = "delete from hms_employeeregistration where emp_id='"+lblop.getText()+"'";        
 ...
 void updatedata() {
       try
       {
        ...
        String up = "UPDATE hms_employeeregistration SET emp_name='" + txtname.getText() + "',emp_age='" +txtage.getText() + "',emp_address='" + txtaddress.getText() + "',emp_phone='" + txtphone.getText() + "',emp_email='"+txtemail.getText()+"',place_id='"+placeid+"'  where emp_id='" + lblop.getText() + "'";
